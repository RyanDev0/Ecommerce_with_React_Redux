...
const DetailComp = ({ productDetail }) => {
  ...
  const addBasket = () => {
    ...
    console.log('Product added to cart:', itemToAdd); // Log product details
  };
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="md:order-1">
          ...
          <button
            className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 mb-4 mt-4" // added mt-4
            onClick={addBasket}
          >
            Add to Basket
          </button>
